...
from load_data import load_datasets # olist/load_data.py에서 load_datasets 함수 임포트

# 이미지 저장 디렉토리 생성
if not os.path.exists('olist/images'):
    os.makedirs('olist/images')
...
def plot_order_status(orders_df):
    ...
    img_path = 'olist/images/plot_1_order_status.png'
...
def plot_payment_types(payments_df):
    ...
    img_path = 'olist/images/plot_2_payment_types.png'
...
def plot_review_scores(reviews_df):
    ...
    img_path = 'olist/images/plot_3_review_scores.png'
...
def plot_sales_by_month(merged_df):
    ...
    img_path = 'olist/images/plot_4_monthly_sales.png'
...
def plot_sales_by_state(merged_df):
    ...
    img_path = 'olist/images/plot_5_sales_by_state.png'
...
def plot_sales_by_category(merged_df):
    ...
    img_path = 'olist/images/plot_6_sales_by_category.png'
...
def plot_hourly_orders(merged_df):
    ...
    img_path = 'olist/images/plot_7_hourly_orders.png'
...
def plot_top_customers(merged_df):
    ...
    img_path = 'olist/images/plot_8_top_customers.png'
...
def plot_price_distribution(items_df):
    ...
    img_path = 'olist/images/plot_9_price_distribution.png'
...
def plot_freight_value_distribution(items_df):
    ...
    img_path = 'olist/images/plot_10_freight_value_distribution.png'
...
def plot_top_products_by_quantity(merged_df):
    ...
    img_path = 'olist/images/plot_11_top_products_quantity.png'
...
def plot_customer_segmentation(merged_df):
    ...
    img_path = 'olist/images/plot_12_customer_segmentation.png'
...
def main():
    ...
    # 데이터 로드
    datasets = load_datasets('./olist') # olist 디렉토리에서 데이터 로드
    ...
    translation_df = datasets['category_translation']
    ...
    # 마크다운 파일 저장
    with open('olist/EDA_Report.md', 'w', encoding='utf-8') as f:
        f.write(markdown_report)
    
    print("EDA 보고서 생성이 완료되었습니다: olist/EDA_Report.md")
